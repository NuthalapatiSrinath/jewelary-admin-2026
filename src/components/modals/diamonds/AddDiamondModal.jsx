...
// ✅ FIXED: Safe handling of options to prevent "Object not valid as child" error
const SelectGroup = ({
  label,
  name,
  options,
...
const AddDiamondModal = ({ isOpen, onClose, onSave, filters, loading }) => {
  const initialState = {
    sku: "",
    stock: 1,
    available: true,
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Add New Diamond">
